                ...
                <div class="col-xl-12">
                    <div class="card sameheight-item items" data-exclude="xs,sm,lg">
                        ...
                        <ul class="item-list striped">
                            <li class="item item-list-header hidden-sm-down">
                                <div class="item-row">
                                    ...
                                    <div class="item-col item-col-header item-col-date">
                                        <div>
                                            <span>ECASH Balance</span>
                                        </div>
                                    </div>
                                    <div class="item-col item-col-header item-col-date">
                                        <div>
                                            <span>EWALLET Balance</span>
                                        </div>
                                    </div>
                                    <div class="item-col item-col-header item-col-date">
                                        <div>
                            ...
                            <li class="item">
                                <div class="item-row">
                                    <div class="item-col fixed item-col-img xs">
                                        <a href="">
                                            <div class="item-img xs rounded" style="background-image: url({{ asset('/images/Signal-Receiver-icon.png') }})"></div>
                                        </a>
                                    </div>
                                    <div class="item-col item-col-title no-overflow">
                                        <div>
                                            <a href="" class="">
                                                <h4 class="item-title no-wrap"> SMART TELCO. </h4>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <li class="item">
                                <div class="item-row">
                                    ...
                                    <div class="item-col item-col-title no-overflow">
                                        <div>
                                            <a href="" class="">
                                                <h4 class="item-title no-wrap"> GLOBE TELCO. </h4>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="item-col item-col-date">
                            ...
                            <li class="item">
                                <div class="item-row">
                                    ...
                                    <div class="item-col item-col-title no-overflow">
                                        <div>
                                            <a href="" class="">
                                                <h4 class="item-title no-wrap"> SUN TELCO. </h4>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="item-col item-col-date">
                            ...
                            <li class="item" style="border-top: 1px solid #E5E5E5;">
                                <div class="item-row">
                                    <div class="item-col fixed item-col-img xs">
                        ...
                        <div class="card-block">
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active fade in" id="daily">
                                    <p class="title-description"> Sales Report for Daily </p>
                                    <div id="dashboard-daily-chart"></div>
                                </div>
                                <div role="tabpanel" class="tab-pane fade" id="yearly">
                                    <p class="title-description"> Sales Report for Yearly </p>
