...
<head>
    ...
    <title> Portal - LoadCharge v2 </title>
...
<script>(function(d, s, id) {
    ...
    js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.10&appId=299400663806765";
    ...
    <div class="app" id="app">
        ...
        <aside class="sidebar">
            <div class="sidebar-container">
                <div class="sidebar-header">
                    <div class="brand"> Load Charge V2 </div>
                </div>
                <nav class="menu">
                    <ul class="nav metismenu" id="sidebar-menu">
                        ...
                        <li>
                            <a href="">
                                <i class="fa fa-th-large"></i> Transactions
                                <i class="fa arrow"></i>
                            </a>
                            <ul>
                                {{--<a href="#" class="add-image" data-toggle="modal" data-target="#modal-media">--}}
                                <li><a href="#" data-toggle="modal" data-target="#modal-media">ECASH</a></li>
                                <li><a href="/store/list-view">EWALLET</a></li>
                                <li><a href="/store/customer/all">SMART</a></li>
                                <li><a href="/store/customer/all">GLOBE</a></li>
                                <li><a href="/store/customer/all">SUN</a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
        ...
        <footer class="footer">
            <div class="footer-block buttons">
                ...
                <div class="fb-like" data-href="http://kpa21.info/" data-layout="button_count" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
            </div>
            <div class="footer-block author">
                <ul>
                    <li style="font-size: .9em;"> developed by <a href="#">KPA</a> </li>
                </ul>
            </div>
        </footer>
